...
/**
 * Upgrade the database to version 2002.
 *
 * @since 2.0.0
 *
 * @uses _genesis_update_settings()
 */
function genesis_upgrade_2002() {
...
function genesis_upgrade() {
	...
	###########################
	# UPDATE DB TO VERSION 2002
	###########################

	if ( genesis_get_option( 'db_version', null, false ) < '2002' )
		genesis_upgrade_2002();
